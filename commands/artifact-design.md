...
- Teal header with Torch logo, "Generated by Lantern" footer, internal-use disclaimer
...
- Structure: the lantern base template (teal header, Lantern footer, internal-use disclaimer)
