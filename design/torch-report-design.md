# Lantern Report Design Guidelines

Design system for HTML reports generated by Lantern. Read this file when generating any HTML report artifact.
...
│  ...                                    │
├─────────────────────────────────────────┤
│  Footer: "Generated by Lantern" + date  │
└─────────────────────────────────────────┘
```
...
- Footer with "Generated by Lantern" attribution
...
3. **Footer line 1** — "Generated by Lantern · {date}" (Secondary Text Regular: 14px Inter, `--text-secondary`).
4. **Footer line 2** — 'Requested by {User Name} · "{original message}"' — the Slack user and message that triggered the report, for context.
5. **Viewport meta** — `<meta name="viewport" content="width=device-width, initial-scale=1">`.
6. **UTF-8 charset** — `<meta charset="utf-8">`.
